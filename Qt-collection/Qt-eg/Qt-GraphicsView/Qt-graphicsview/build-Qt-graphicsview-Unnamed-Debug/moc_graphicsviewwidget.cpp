/****************************************************************************
** Meta object code from reading C++ file 'graphicsviewwidget.h'
**
...
#include "../Qt-graphicsview/graphicsviewwidget.h"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'graphicsviewwidget.h' doesn't include <QObject>."
...
const QMetaObject graphicsViewWidget::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_graphicsViewWidget.data,
      qt_meta_data_graphicsViewWidget,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *graphicsViewWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_graphicsViewWidget.stringdata0))
        return static_cast<void*>(const_cast< graphicsViewWidget*>(this));
