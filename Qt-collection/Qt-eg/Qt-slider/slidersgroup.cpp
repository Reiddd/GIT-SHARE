...
SlidersGroup::SlidersGroup(Qt::Orientation orientation, const QString &title, QWidget *parent):QGroupBox(title,parent)
{
    ...
    QHBoxLayout::Direction direction;
...
void SlidersGroup::invertedAppearance(bool invert)
{
...
void SlidersGroup::invertedKeyBindings(bool invert)
{
