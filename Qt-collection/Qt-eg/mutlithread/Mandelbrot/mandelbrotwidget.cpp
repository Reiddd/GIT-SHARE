...
void MandelbrotWidget::paintEvent(QPaintEvent* event){
    ...
    painter.fillRect(rect(), Qt::black); /* QWidget::rect() == QRect(0, 0, QWidget::width(), QWidget::height()) */
    ...
    painter.drawRect((width() - textWidth)/2 - 5, 0,
                     textWidth + 10             , metrics.lineSpacing() + 5);
    painter.setPen(Qt::white);
